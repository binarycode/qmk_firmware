...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   * | Z      | X      | C      | V      | B      || N      | M      | ,      | .      | /      |
   * '--------+--------+--------+--------+--------||--------+--------+--------+--------+--------'
   *          |        | LCTRL  | ESCAPE | FN     || NUM    | BACKSP | TAB    |        |
   *          |--------+--------+--------+--------||--------+--------+--------+--------|
   *          | LGUI   | LALT   | SPACE  | LSHIFT || RSHIFT | ENTER  | RALT   |        |
   *          '-----------------------------------''-----------------------------------'
   */
  [BASE] = LAYOUT(
    ...
    KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,           KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH,
             XXXXXXX, KC_LCTL, KC_ESC,  MO(FN),         MO(NUM), KC_BSPC, KC_TAB,  XXXXXXX,
             KC_LGUI, KC_LALT, KC_SPC,  KC_LSFT,        KC_RSFT, KC_ENT,  KC_RALT, XXXXXXX
  ),
